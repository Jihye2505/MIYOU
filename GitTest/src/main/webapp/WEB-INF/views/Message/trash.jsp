						...
						<form method="post" action="deleteMessage">
							...
							<div class="mail-box">
								<table class="table table-hover table-mail">
									<tbody>
										<c:forEach var="t" items="${trashMessageList}">
											<tr class="${t.checked}">
												<td class="check-mail">
												<input type="checkbox" class="iCheck" name="check" value="${t.message_num}"></td>
												<td class="mail-ontact">${t.employee_num}
												<c:if test="${t.notice=='N'}"><span class="label label-info pull-right">Notice</span></c:if>
												</td>
												<td class="mail-subject">${t.content }</td>
												<td></td>
												<td class="text-right mail-date">${t.send_date}</td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
