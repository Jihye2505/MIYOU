...
$(document).ready(function(){
	$("#inputButton").on("click",function(){
		var myData = {userLanguage:"ko", inputText:$("#inputText").val()};
		$.ajax({
			method:"get"
			,url:"translate"
			,data:myData
...
<body>
   ...
   <div class="center">
      ...
      <div class="sidebyside">
         ...
         <div id="email_info" class="info">
            Text sent to default email application.<br> (See
            chrome://settings/handlers to change.)
         </div>
      </div>
      <p>
      <div id="div_language">
   ...
   <textarea lang="kr" id="inputText" name="inputText" rows="3" cols="100"></textarea>
   <input type="button" id="inputButton" value="Translate">
   <div lang="jp" id="translatedText"></div>
