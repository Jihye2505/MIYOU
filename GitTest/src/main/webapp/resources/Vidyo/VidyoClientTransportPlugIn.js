...
function VidyoClientTransport(plugInObj, onStatus, onCallback, plugInDivId){
	...
	this.AddPlugInIntoDOM = function(parentDivId, plugInDivId, type) {
		...
		if(DEBUG) {
			...
			html += "<object type='application/x-VidyoClientPlugIn' id='" + plugInDivId + "' vidyoclientplugin_id='" + plugInId + "' vidyoclientplugin_type='" + type + "' class='VidyoClientPlugIn' style='width: 100%; height: 100%;'>";
