...
function VidyoClient(plugInDivId, onStatus)
{
	...
	this.VidyoCalendarManager = function(feedback) {
		...
		this.CreateCalendarInstance = function(feedback, svcId, calendarName, createToken) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('feedback') && arguments[0].hasOwnProperty('svcId') && arguments[0].hasOwnProperty('calendarName') && arguments[0].hasOwnProperty('createToken')){
					...
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['feedback', 'svcId', 'calendarName', 'createToken'], Object.keys(arguments[0])).error);
				}
		...
		this.GetCalendarTypes = function(serviceTypes) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('serviceTypes')){
					var params = VCUtils.jQuery.param({calendarMgr: this.objId, serviceTypes: JSON.stringify({"serviceTypes": arguments[0].serviceTypes})});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['serviceTypes'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
	...
	this.CreateVidyoCalendarManagerFeedback = function(serviceStatus, uninitialized, calendarCreated) {
		var args = [].slice.apply(arguments);
		if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
			if(arguments[0].hasOwnProperty('serviceStatus') && arguments[0].hasOwnProperty('uninitialized') && arguments[0].hasOwnProperty('calendarCreated')){
				var params = VCUtils.jQuery.param({f: this.objId});
			} else {
				return Promise.reject(new MissingArgumentException('Missing Parameters', ['serviceStatus', 'uninitialized', 'calendarCreated'], Object.keys(arguments[0])).error);
			}
		...
		if(arguments.length === 1 && arguments[0].objId && arguments[0].objType && arguments[0].objType === "VidyoCalendarManagerFeedback"){
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('serviceStatus') && arguments[0].hasOwnProperty('uninitialized') && arguments[0].hasOwnProperty('calendarCreated')){
					...
					throw new MissingArgumentException('Missing Parameters', ['serviceStatus', 'uninitialized', 'calendarCreated'], Object.keys(arguments[0])).error;
				}
			} else if (arguments.length === 3 && (typeof(arguments[0]) === "function") && (typeof(arguments[1]) === "function") && (typeof(arguments[2]) === "function")){
	...
	this.VidyoCalendar = function(){
		...
		this.CreateMeeting = function(feedback, meeting, createToken) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('feedback') && arguments[0].hasOwnProperty('meeting') && arguments[0].hasOwnProperty('createToken')){
					...
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['feedback', 'meeting', 'createToken'], Object.keys(arguments[0])).error);
				}
		...
		this.GetMeetingsByMonth = function(year, month, createToken) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('year') && arguments[0].hasOwnProperty('month') && arguments[0].hasOwnProperty('createToken')){
					...
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['year', 'month', 'createToken'], Object.keys(arguments[0])).error);
				}
		...
		this.SearchMeetings = function(searchText, beginDate, endDate, index, pageSize) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('searchText') && arguments[0].hasOwnProperty('beginDate') && arguments[0].hasOwnProperty('endDate') && arguments[0].hasOwnProperty('index') && arguments[0].hasOwnProperty('pageSize')){
					...
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['searchText', 'beginDate', 'endDate', 'index', 'pageSize'], Object.keys(arguments[0])).error);
				}
		...
		this.SetRoomIdMatchString = function(regexp) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('regexp')){
					var params = VCUtils.jQuery.param({c: this.objId, regexp: arguments[0].regexp});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['regexp'], Object.keys(arguments[0])).error);
				}
	...
	this.CreateVidyoCalendarFeedback = function(connectState, disconnected, meetingEvent, meetingCreatedByService, meetingCreated, meetingUpdatedByService, meetingUpdated, meetingRemovedByService, meetingRemoved, getMeetingResults) {
		var args = [].slice.apply(arguments);
		if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
			if(arguments[0].hasOwnProperty('connectState') && arguments[0].hasOwnProperty('disconnected') && arguments[0].hasOwnProperty('meetingEvent') && arguments[0].hasOwnProperty('meetingCreatedByService') && arguments[0].hasOwnProperty('meetingCreated') && arguments[0].hasOwnProperty('meetingUpdatedByService') && arguments[0].hasOwnProperty('meetingUpdated') && arguments[0].hasOwnProperty('meetingRemovedByService') && arguments[0].hasOwnProperty('meetingRemoved') && arguments[0].hasOwnProperty('getMeetingResults')){
				var params = VCUtils.jQuery.param({f: this.objId});
			} else {
				return Promise.reject(new MissingArgumentException('Missing Parameters', ['connectState', 'disconnected', 'meetingEvent', 'meetingCreatedByService', 'meetingCreated', 'meetingUpdatedByService', 'meetingUpdated', 'meetingRemovedByService', 'meetingRemoved', 'getMeetingResults'], Object.keys(arguments[0])).error);
			}
		...
		if(arguments.length === 1 && arguments[0].objId && arguments[0].objType && arguments[0].objType === "VidyoCalendarFeedback"){
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('connectState') && arguments[0].hasOwnProperty('disconnected') && arguments[0].hasOwnProperty('meetingEvent') && arguments[0].hasOwnProperty('meetingCreatedByService') && arguments[0].hasOwnProperty('meetingCreated') && arguments[0].hasOwnProperty('meetingUpdatedByService') && arguments[0].hasOwnProperty('meetingUpdated') && arguments[0].hasOwnProperty('meetingRemovedByService') && arguments[0].hasOwnProperty('meetingRemoved') && arguments[0].hasOwnProperty('getMeetingResults')){
					...
					throw new MissingArgumentException('Missing Parameters', ['connectState', 'disconnected', 'meetingEvent', 'meetingCreatedByService', 'meetingCreated', 'meetingUpdatedByService', 'meetingUpdated', 'meetingRemovedByService', 'meetingRemoved', 'getMeetingResults'], Object.keys(arguments[0])).error;
				}
			} else if (arguments.length === 10 && (typeof(arguments[0]) === "function") && (typeof(arguments[1]) === "function") && (typeof(arguments[2]) === "function") && (typeof(arguments[3]) === "function") && (typeof(arguments[4]) === "function") && (typeof(arguments[5]) === "function") && (typeof(arguments[6]) === "function") && (typeof(arguments[7]) === "function") && (typeof(arguments[8]) === "function") && (typeof(arguments[9]) === "function")){
	...
	this.VidyoConnector = function(viewId, viewStyle, remoteParticipants, logFileFilter, logFileName, userData) {
		...
		this.AssignViewToLocalCamera = function(viewId, localCamera, displayCropped, allowZoom) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('localCamera') && arguments[0].hasOwnProperty('displayCropped') && arguments[0].hasOwnProperty('allowZoom')){
					arguments[0].viewId = UpdateViewOnDOM("AssignViewToLocalCamera", arguments[0].viewId, arguments[0].localCamera, arguments[0].displayCropped, arguments[0].allowZoom);
					var params = VCUtils.jQuery.param({c: this.objId, viewId: arguments[0].viewId, localCamera: (arguments[0].localCamera ? arguments[0].localCamera.objId : 0), displayCropped: arguments[0].displayCropped, allowZoom: arguments[0].allowZoom});
				} else {
				...
				arguments[0] = UpdateViewOnDOM("AssignViewToLocalCamera", viewId, localCamera, displayCropped, allowZoom);
				var params = VCUtils.jQuery.param({c: this.objId, viewId: arguments[0], localCamera: (arguments[1] ? arguments[1].objId : 0), displayCropped: arguments[2], allowZoom: arguments[3]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
				function OnComplete(response) {
					if(localCamera&& response.data.localCamera)
						VCUtils.jQuery.extend(localCamera, response.data.localCamera);
					resolve(response.data.retValue);
				}
				function OnError(response) {
					reject(Error(response));
		...
		this.AssignViewToRemoteCamera = function(viewId, remoteCamera, displayCropped, allowZoom) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('remoteCamera') && arguments[0].hasOwnProperty('displayCropped') && arguments[0].hasOwnProperty('allowZoom')){
					arguments[0].viewId = UpdateViewOnDOM("AssignViewToRemoteCamera", arguments[0].viewId, arguments[0].remoteCamera, arguments[0].displayCropped, arguments[0].allowZoom);
					var params = VCUtils.jQuery.param({c: this.objId, viewId: arguments[0].viewId, remoteCamera: (arguments[0].remoteCamera ? arguments[0].remoteCamera.objId : 0), displayCropped: arguments[0].displayCropped, allowZoom: arguments[0].allowZoom});
				} else {
				...
				arguments[0] = UpdateViewOnDOM("AssignViewToRemoteCamera", viewId, remoteCamera, displayCropped, allowZoom);
				var params = VCUtils.jQuery.param({c: this.objId, viewId: arguments[0], remoteCamera: (arguments[1] ? arguments[1].objId : 0), displayCropped: arguments[2], allowZoom: arguments[3]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
				function OnComplete(response) {
					if(remoteCamera&& response.data.remoteCamera)
						VCUtils.jQuery.extend(remoteCamera, response.data.remoteCamera);
					resolve(response.data.retValue);
				}
				function OnError(response) {
					reject(Error(response));
		...
		this.AssignViewToRemoteWindowShare = function(viewId, remoteWindowShare, displayCropped, allowZoom) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('remoteWindowShare') && arguments[0].hasOwnProperty('displayCropped') && arguments[0].hasOwnProperty('allowZoom')){
					arguments[0].viewId = UpdateViewOnDOM("AssignViewToRemoteWindowShare", arguments[0].viewId, arguments[0].remoteWindowShare, arguments[0].displayCropped, arguments[0].allowZoom);
					var params = VCUtils.jQuery.param({c: this.objId, viewId: arguments[0].viewId, remoteWindowShare: (arguments[0].remoteWindowShare ? arguments[0].remoteWindowShare.objId : 0), displayCropped: arguments[0].displayCropped, allowZoom: arguments[0].allowZoom});
				} else {
				...
				arguments[0] = UpdateViewOnDOM("AssignViewToRemoteWindowShare", viewId, remoteWindowShare, displayCropped, allowZoom);
				var params = VCUtils.jQuery.param({c: this.objId, viewId: arguments[0], remoteWindowShare: (arguments[1] ? arguments[1].objId : 0), displayCropped: arguments[2], allowZoom: arguments[3]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
				function OnComplete(response) {
					if(remoteWindowShare&& response.data.remoteWindowShare)
						VCUtils.jQuery.extend(remoteWindowShare, response.data.remoteWindowShare);
					resolve(response.data.retValue);
				}
				function OnError(response) {
					reject(Error(response));
		...
		this.EnableDebug = function(port, logFilter) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('port') && arguments[0].hasOwnProperty('logFilter')){
					var params = VCUtils.jQuery.param({c: this.objId, port: arguments[0].port, logFilter: arguments[0].logFilter});
				} else {
				...
				var params = VCUtils.jQuery.param({c: this.objId, port: arguments[0], logFilter: arguments[1]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.RegisterRecoderInCallEventListener = function(onRecorderInCallChanged) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
			...
			return new Promise(function(resolve, reject){
				...
				GetRequest("VidyoConnectorRegisterRecoderInCallEventListener?" + params, OnComplete, OnError);
			});
		}
		...
		this.SelectLocalCamera = function(localCamera) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('localCamera')){
					var params = VCUtils.jQuery.param({c: this.objId, localCamera: (arguments[0].localCamera ? arguments[0].localCamera.objId : 0)});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['localCamera'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
				var params = VCUtils.jQuery.param({c: this.objId, localCamera: (arguments[0] ? arguments[0].objId : 0)});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.SelectLocalMicrophone = function(localMicrophone) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('localMicrophone')){
					var params = VCUtils.jQuery.param({c: this.objId, localMicrophone: (arguments[0].localMicrophone ? arguments[0].localMicrophone.objId : 0)});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['localMicrophone'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
				var params = VCUtils.jQuery.param({c: this.objId, localMicrophone: (arguments[0] ? arguments[0].objId : 0)});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.SelectLocalMonitor = function(localMonitor) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('localMonitor')){
					var params = VCUtils.jQuery.param({c: this.objId, localMonitor: (arguments[0].localMonitor ? arguments[0].localMonitor.objId : 0)});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['localMonitor'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
				var params = VCUtils.jQuery.param({c: this.objId, localMonitor: (arguments[0] ? arguments[0].objId : 0)});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.SelectLocalSpeaker = function(localSpeaker) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('localSpeaker')){
					var params = VCUtils.jQuery.param({c: this.objId, localSpeaker: (arguments[0].localSpeaker ? arguments[0].localSpeaker.objId : 0)});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['localSpeaker'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
				var params = VCUtils.jQuery.param({c: this.objId, localSpeaker: (arguments[0] ? arguments[0].objId : 0)});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.SelectLocalWindowShare = function(localWindowShare) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('localWindowShare')){
					var params = VCUtils.jQuery.param({c: this.objId, localWindowShare: (arguments[0].localWindowShare ? arguments[0].localWindowShare.objId : 0)});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['localWindowShare'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
				var params = VCUtils.jQuery.param({c: this.objId, localWindowShare: (arguments[0] ? arguments[0].objId : 0)});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.SetLocation = function(latitude, longitude) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('latitude') && arguments[0].hasOwnProperty('longitude')){
					var params = VCUtils.jQuery.param({c: this.objId, latitude: arguments[0].latitude, longitude: arguments[0].longitude});
				} else {
				...
				var params = VCUtils.jQuery.param({c: this.objId, latitude: arguments[0], longitude: arguments[1]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.SetViewAnimationSpeed = function(viewId, speedPercentage) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('speedPercentage')){
					arguments[0].viewId = UpdateViewOnDOM("SetViewAnimationSpeed", arguments[0].viewId, arguments[0].speedPercentage);
					var params = VCUtils.jQuery.param({c: this.objId, viewId: arguments[0].viewId, speedPercentage: arguments[0].speedPercentage});
				} else {
				...
				arguments[0] = UpdateViewOnDOM("SetViewAnimationSpeed", viewId, speedPercentage);
				var params = VCUtils.jQuery.param({c: this.objId, viewId: arguments[0], speedPercentage: arguments[1]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.SetViewBackgroundColor = function(viewId, red, green, blue) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('red') && arguments[0].hasOwnProperty('green') && arguments[0].hasOwnProperty('blue')){
					arguments[0].viewId = UpdateViewOnDOM("SetViewBackgroundColor", arguments[0].viewId, arguments[0].red, arguments[0].green, arguments[0].blue);
					var params = VCUtils.jQuery.param({c: this.objId, viewId: arguments[0].viewId, red: arguments[0].red, green: arguments[0].green, blue: arguments[0].blue});
				} else {
				...
				arguments[0] = UpdateViewOnDOM("SetViewBackgroundColor", viewId, red, green, blue);
				var params = VCUtils.jQuery.param({c: this.objId, viewId: arguments[0], red: arguments[1], green: arguments[2], blue: arguments[3]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.SetWebProxyAddressCredentials = function(proxyAddress, username, password) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('proxyAddress') && arguments[0].hasOwnProperty('username') && arguments[0].hasOwnProperty('password')){
					var params = VCUtils.jQuery.param({c: this.objId, proxyAddress: arguments[0].proxyAddress, username: arguments[0].username, password: arguments[0].password});
				} else {
				...
				var params = VCUtils.jQuery.param({c: this.objId, proxyAddress: arguments[0], username: arguments[1], password: arguments[2]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.ShowViewLabel = function(viewId, showLabel) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('showLabel')){
					arguments[0].viewId = UpdateViewOnDOM("ShowViewLabel", arguments[0].viewId, arguments[0].showLabel);
					var params = VCUtils.jQuery.param({c: this.objId, viewId: arguments[0].viewId, showLabel: arguments[0].showLabel});
				} else {
				...
				arguments[0] = UpdateViewOnDOM("ShowViewLabel", viewId, showLabel);
				var params = VCUtils.jQuery.param({c: this.objId, viewId: arguments[0], showLabel: arguments[1]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.UnregisterRecoderInCallEventListener = function() {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				var params = VCUtils.jQuery.param({c: this.objId});
			} else if (arguments.length === 0){
			...
			return new Promise(function(resolve, reject){
				...
				GetRequest("VidyoConnectorUnregisterRecoderInCallEventListener?" + params, OnComplete, OnError);
			});
		}
		...
		this.SetMaxConstraint = function(width, height, frameInterval) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('width') && arguments[0].hasOwnProperty('height') && arguments[0].hasOwnProperty('frameInterval')){
					var params = VCUtils.jQuery.param({c: this.objId, width: arguments[0].width, height: arguments[0].height, frameInterval: arguments[0].frameInterval});
				} else {
				...
				var params = VCUtils.jQuery.param({c: this.objId, width: arguments[0], height: arguments[1], frameInterval: arguments[2]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.SetPreviewLabel = function(previewLabel) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('previewLabel')){
					var params = VCUtils.jQuery.param({c: this.objId, previewLabel: arguments[0].previewLabel});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['previewLabel'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "string")){
				var params = VCUtils.jQuery.param({c: this.objId, previewLabel: arguments[0]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
	...
	this.VidyoLocalMicrophone = function(){
		...
		this.SetSignalType = function(signalType) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('signalType')){
					var params = VCUtils.jQuery.param({m: this.objId, signalType: arguments[0].signalType});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['signalType'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "string")){
				var params = VCUtils.jQuery.param({m: this.objId, signalType: arguments[0]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.SetVoiceProcessing = function(voiceProcessing) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('voiceProcessing')){
					var params = VCUtils.jQuery.param({m: this.objId, voiceProcessing: arguments[0].voiceProcessing});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['voiceProcessing'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "boolean")){
		...
		this.ControlPTZ = function(pan, tilt, zoom) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('pan') && arguments[0].hasOwnProperty('tilt') && arguments[0].hasOwnProperty('zoom')){
					var params = VCUtils.jQuery.param({c: this.objId, pan: arguments[0].pan, tilt: arguments[0].tilt, zoom: arguments[0].zoom});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['pan', 'tilt', 'zoom'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 3 && (typeof(arguments[0]) === "number") && (typeof(arguments[1]) === "number") && (typeof(arguments[2]) === "number")){
				var params = VCUtils.jQuery.param({c: this.objId, pan: arguments[0], tilt: arguments[1], zoom: arguments[2]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
				...
				GetRequest("VidyoRemoteCameraControlPTZ?" + params, OnComplete, OnError);
			});
		}
	...
	this.VidyoRemoteWindowShare = function(){
		...
		this.SetPositionInLocalRenderer = function(localRenderer, x, y, width, height, frameInterval) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('localRenderer') && arguments[0].hasOwnProperty('x') && arguments[0].hasOwnProperty('y') && arguments[0].hasOwnProperty('width') && arguments[0].hasOwnProperty('height') && arguments[0].hasOwnProperty('frameInterval')){
					var params = VCUtils.jQuery.param({w: this.objId, localRenderer: (arguments[0].localRenderer ? arguments[0].localRenderer.objId : 0), x: arguments[0].x, y: arguments[0].y, width: arguments[0].width, height: arguments[0].height, frameInterval: arguments[0].frameInterval});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['localRenderer', 'x', 'y', 'width', 'height', 'frameInterval'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 6 && (typeof(arguments[0]) === "object") && (typeof(arguments[1]) === "number") && (typeof(arguments[2]) === "number") && (typeof(arguments[3]) === "number") && (typeof(arguments[4]) === "number") && (typeof(arguments[5]) === "number")){
				var params = VCUtils.jQuery.param({w: this.objId, localRenderer: (arguments[0] ? arguments[0].objId : 0), x: arguments[1], y: arguments[2], width: arguments[3], height: arguments[4], frameInterval: arguments[5]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
	...
	this.VidyoVirtualShareManager = function(){
		...
		this.Destruct = function() {
			GetRequest("VidyoVirtualShareManagerDestruct?" + VCUtils.jQuery.param({ obj: this.objId }), function(){}, function(){});
			delete objects[this.objId];
		}
	...
	this.VidyoCall = function(){
		...
		this.GetParticipants = function(participants) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('participants')){
					var params = VCUtils.jQuery.param({c: this.objId, participants: JSON.stringify({"participants": arguments[0].participants})});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['participants'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
		...
		this.GetRemoteRenderers = function(renderers) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('renderers')){
					var params = VCUtils.jQuery.param({c: this.objId, renderers: JSON.stringify({"renderers": arguments[0].renderers})});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['renderers'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
		...
		this.GetRemoteSpeakers = function(speakers) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('speakers')){
					var params = VCUtils.jQuery.param({c: this.objId, speakers: JSON.stringify({"speakers": arguments[0].speakers})});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['speakers'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
	...
	this.CreateVidyoEndpoint = function(viewId, viewStyle, remoteParticipants, consoleLogFilter, fileLogFilter, fileLogName) {
		var args = [].slice.apply(arguments);
		if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
			if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('viewStyle') && arguments[0].hasOwnProperty('remoteParticipants') && arguments[0].hasOwnProperty('consoleLogFilter') && arguments[0].hasOwnProperty('fileLogFilter') && arguments[0].hasOwnProperty('fileLogName')){
				...
				return Promise.reject(new MissingArgumentException('Missing Parameters', ['viewId', 'viewStyle', 'remoteParticipants', 'consoleLogFilter', 'fileLogFilter', 'fileLogName'], Object.keys(arguments[0])).error);
			}
	...
	this.VidyoEndpoint = function(viewId, viewStyle, remoteParticipants, consoleLogFilter, fileLogFilter, fileLogName) {
		if(arguments.length === 1 && arguments[0].objId && arguments[0].objType && arguments[0].objType === "VidyoEndpoint"){
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('viewStyle') && arguments[0].hasOwnProperty('remoteParticipants') && arguments[0].hasOwnProperty('consoleLogFilter') && arguments[0].hasOwnProperty('fileLogFilter') && arguments[0].hasOwnProperty('fileLogName')){
					...
					throw new MissingArgumentException('Missing Parameters', ['viewId', 'viewStyle', 'remoteParticipants', 'consoleLogFilter', 'fileLogFilter', 'fileLogName'], Object.keys(arguments[0])).error;
				}
			} else if (arguments.length === 6 && (typeof(arguments[0]) === "string") && (typeof(arguments[1]) === "string") && (typeof(arguments[2]) === "number") && (typeof(arguments[3]) === "string") && (typeof(arguments[4]) === "string") && (typeof(arguments[5]) === "string")){
		...
		this.AssignViewToLocalCamera = function(viewId, localCamera, displayCropped, allowZoom) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('localCamera') && arguments[0].hasOwnProperty('displayCropped') && arguments[0].hasOwnProperty('allowZoom')){
					arguments[0].viewId = UpdateViewOnDOM("AssignViewToLocalCamera", arguments[0].viewId, arguments[0].localCamera, arguments[0].displayCropped, arguments[0].allowZoom);
					var params = VCUtils.jQuery.param({e: this.objId, viewId: arguments[0].viewId, localCamera: (arguments[0].localCamera ? arguments[0].localCamera.objId : 0), displayCropped: arguments[0].displayCropped, allowZoom: arguments[0].allowZoom});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['viewId', 'localCamera', 'displayCropped', 'allowZoom'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 4 && (typeof(arguments[0]) === "string") && (typeof(arguments[1]) === "object") && (typeof(arguments[2]) === "boolean") && (typeof(arguments[3]) === "boolean")){
				arguments[0] = UpdateViewOnDOM("AssignViewToLocalCamera", viewId, localCamera, displayCropped, allowZoom);
				var params = VCUtils.jQuery.param({e: this.objId, viewId: arguments[0], localCamera: (arguments[1] ? arguments[1].objId : 0), displayCropped: arguments[2], allowZoom: arguments[3]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.AssignViewToRemoteCamera = function(viewId, camera, displayCropped, allowZoom) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('camera') && arguments[0].hasOwnProperty('displayCropped') && arguments[0].hasOwnProperty('allowZoom')){
					...
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['viewId', 'camera', 'displayCropped', 'allowZoom'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 4 && (typeof(arguments[0]) === "string") && (typeof(arguments[1]) === "object") && (typeof(arguments[2]) === "boolean") && (typeof(arguments[3]) === "boolean")){
		...
		this.AssignViewToRemoteWindowShare = function(viewId, remoteWindowShare, displayCropped, allowZoom) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('remoteWindowShare') && arguments[0].hasOwnProperty('displayCropped') && arguments[0].hasOwnProperty('allowZoom')){
					arguments[0].viewId = UpdateViewOnDOM("AssignViewToRemoteWindowShare", arguments[0].viewId, arguments[0].remoteWindowShare, arguments[0].displayCropped, arguments[0].allowZoom);
					var params = VCUtils.jQuery.param({e: this.objId, viewId: arguments[0].viewId, remoteWindowShare: (arguments[0].remoteWindowShare ? arguments[0].remoteWindowShare.objId : 0), displayCropped: arguments[0].displayCropped, allowZoom: arguments[0].allowZoom});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['viewId', 'remoteWindowShare', 'displayCropped', 'allowZoom'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 4 && (typeof(arguments[0]) === "string") && (typeof(arguments[1]) === "object") && (typeof(arguments[2]) === "boolean") && (typeof(arguments[3]) === "boolean")){
				arguments[0] = UpdateViewOnDOM("AssignViewToRemoteWindowShare", viewId, remoteWindowShare, displayCropped, allowZoom);
				var params = VCUtils.jQuery.param({e: this.objId, viewId: arguments[0], remoteWindowShare: (arguments[1] ? arguments[1].objId : 0), displayCropped: arguments[2], allowZoom: arguments[3]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.EnableFileLogger = function(fileLogName, fileLogFilter) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('fileLogName') && arguments[0].hasOwnProperty('fileLogFilter')){
					var params = VCUtils.jQuery.param({e: this.objId, fileLogName: arguments[0].fileLogName, fileLogFilter: arguments[0].fileLogFilter});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['fileLogName', 'fileLogFilter'], Object.keys(arguments[0])).error);
				}
		...
		this.LocalCameraSelectAdvanced = function(localCamera, previewedPreCall, previewedInCall) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('localCamera') && arguments[0].hasOwnProperty('previewedPreCall') && arguments[0].hasOwnProperty('previewedInCall')){
					...
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['localCamera', 'previewedPreCall', 'previewedInCall'], Object.keys(arguments[0])).error);
				}
		...
		this.LocalMonitorSelectAdvanced = function(localMonitor, previewed) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('localMonitor') && arguments[0].hasOwnProperty('previewed')){
					...
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['localMonitor', 'previewed'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 2 && (typeof(arguments[0]) === "object") && (typeof(arguments[1]) === "boolean")){
		...
		this.LocalWindowShareSelectAdvanced = function(localWindowShare, previewed) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('localWindowShare') && arguments[0].hasOwnProperty('previewed')){
					...
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['localWindowShare', 'previewed'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 2 && (typeof(arguments[0]) === "object") && (typeof(arguments[1]) === "boolean")){
		...
		this.RegisterRemoteRendererEventListener = function(onAdded, onRemoved) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('onAdded') && arguments[0].hasOwnProperty('onRemoved')){
					...
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['onAdded', 'onRemoved'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 2 && (typeof(arguments[0]) === "function") && (typeof(arguments[1]) === "function")){
		...
		this.SetDebugFilter = function(debugLogFilter) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('debugLogFilter')){
					var params = VCUtils.jQuery.param({e: this.objId, debugLogFilter: arguments[0].debugLogFilter});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['debugLogFilter'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "string")){
				var params = VCUtils.jQuery.param({e: this.objId, debugLogFilter: arguments[0]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.SetFileLoggerFilter = function(fileLogFilter) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('fileLogFilter')){
					var params = VCUtils.jQuery.param({e: this.objId, fileLogFilter: arguments[0].fileLogFilter});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['fileLogFilter'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "string")){
		...
		this.SetPoolId = function(poolId) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('poolId')){
					var params = VCUtils.jQuery.param({e: this.objId, poolId: arguments[0].poolId});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['poolId'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "string")){
		...
		this.SetViewAnimationSpeed = function(viewId, speedPercentage) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('speedPercentage')){
					arguments[0].viewId = UpdateViewOnDOM("SetViewAnimationSpeed", arguments[0].viewId, arguments[0].speedPercentage);
					var params = VCUtils.jQuery.param({e: this.objId, viewId: arguments[0].viewId, speedPercentage: arguments[0].speedPercentage});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['viewId', 'speedPercentage'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 2 && (typeof(arguments[0]) === "string") && (typeof(arguments[1]) === "number")){
				arguments[0] = UpdateViewOnDOM("SetViewAnimationSpeed", viewId, speedPercentage);
				var params = VCUtils.jQuery.param({e: this.objId, viewId: arguments[0], speedPercentage: arguments[1]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.SetViewBackgroundColor = function(viewId, red, green, blue) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('red') && arguments[0].hasOwnProperty('green') && arguments[0].hasOwnProperty('blue')){
					arguments[0].viewId = UpdateViewOnDOM("SetViewBackgroundColor", arguments[0].viewId, arguments[0].red, arguments[0].green, arguments[0].blue);
					var params = VCUtils.jQuery.param({e: this.objId, viewId: arguments[0].viewId, red: arguments[0].red, green: arguments[0].green, blue: arguments[0].blue});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['viewId', 'red', 'green', 'blue'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 4 && (typeof(arguments[0]) === "string") && (typeof(arguments[1]) === "number") && (typeof(arguments[2]) === "number") && (typeof(arguments[3]) === "number")){
				arguments[0] = UpdateViewOnDOM("SetViewBackgroundColor", viewId, red, green, blue);
				var params = VCUtils.jQuery.param({e: this.objId, viewId: arguments[0], red: arguments[1], green: arguments[2], blue: arguments[3]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.ShowViewLabel = function(viewId, showLabel) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('showLabel')){
					arguments[0].viewId = UpdateViewOnDOM("ShowViewLabel", arguments[0].viewId, arguments[0].showLabel);
					var params = VCUtils.jQuery.param({e: this.objId, viewId: arguments[0].viewId, showLabel: arguments[0].showLabel});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['viewId', 'showLabel'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 2 && (typeof(arguments[0]) === "string") && (typeof(arguments[1]) === "boolean")){
				arguments[0] = UpdateViewOnDOM("ShowViewLabel", viewId, showLabel);
				var params = VCUtils.jQuery.param({e: this.objId, viewId: arguments[0], showLabel: arguments[1]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.StartShareDetection = function() {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				var params = VCUtils.jQuery.param({e: this.objId});
			} else if (arguments.length === 0){
			...
			return new Promise(function(resolve, reject){
				...
				GetRequest("VidyoEndpointStartShareDetection?" + params, OnComplete, OnError);
			});
		}
		...
		this.StopShareDetection = function() {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				var params = VCUtils.jQuery.param({e: this.objId});
			} else if (arguments.length === 0){
			...
			return new Promise(function(resolve, reject){
				...
				GetRequest("VidyoEndpointStopShareDetection?" + params, OnComplete, OnError);
			});
		}
		...
		this.ValidateLicenseKey = function(licenseKey, isValid) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('licenseKey') && arguments[0].hasOwnProperty('isValid')){
					var params = VCUtils.jQuery.param({e: this.objId, licenseKey: arguments[0].licenseKey, isValid: arguments[0].isValid});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['licenseKey', 'isValid'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 2 && (typeof(arguments[0]) === "string") && (typeof(arguments[1]) === "boolean")){
	...
	this.VidyoRoom = function(){
		...
		this.AcceptIncoming = function(onEntered, onExited) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('onEntered') && arguments[0].hasOwnProperty('onExited')){
					this.VidyoRoomOnEntered = arguments[0].onEntered;
					this.VidyoRoomOnExited = arguments[0].onExited;
					var params = VCUtils.jQuery.param({r: this.objId});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['onEntered', 'onExited'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 2 && (typeof(arguments[0]) === "function") && (typeof(arguments[1]) === "function")){
		...
		this.AcquireMediaRoute = function(onMediaRouteAcquired) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('onMediaRouteAcquired')){
					this.VidyoRoomOnMediaRouteAcquired = arguments[0].onMediaRouteAcquired;
					var params = VCUtils.jQuery.param({r: this.objId});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['onMediaRouteAcquired'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "function")){
		...
		this.GetSelectedLocalCameras = function(cameras) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('cameras')){
					var params = VCUtils.jQuery.param({r: this.objId, cameras: JSON.stringify({"cameras": arguments[0].cameras})});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['cameras'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
		...
		this.GetSelectedLocalMicrophones = function(mics) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('mics')){
					var params = VCUtils.jQuery.param({r: this.objId, mics: JSON.stringify({"mics": arguments[0].mics})});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['mics'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
		...
		this.GetSelectedLocalWindowShares = function(windowShares) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('windowShares')){
					var params = VCUtils.jQuery.param({r: this.objId, windowShares: JSON.stringify({"windowShares": arguments[0].windowShares})});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['windowShares'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
		...
		this.GetStats = function(stats) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('stats')){
					var params = VCUtils.jQuery.param({r: this.objId, stats: JSON.stringify(arguments[0].stats)});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['stats'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
		...
		this.Invite = function(userId, message) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('userId') && arguments[0].hasOwnProperty('message')){
					var params = VCUtils.jQuery.param({r: this.objId, userId: arguments[0].userId, message: arguments[0].message});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['userId', 'message'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 2 && (typeof(arguments[0]) === "string") && (typeof(arguments[1]) === "string")){
		...
		this.InviteN = function(userIds, message) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('userIds') && arguments[0].hasOwnProperty('message')){
					...
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['userIds', 'message'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 2 && (typeof(arguments[0]) === "object") && (typeof(arguments[1]) === "string")){
		...
		this.RegisterRecoderInCallEventListener = function(onRecorderInCallChanged) {
			...
			return new Promise(function(resolve, reject){
				...
				GetRequest("VidyoRoomRegisterRecoderInCallEventListener?" + params, OnComplete, OnError);
			});
		}
		...
		this.SetUserData = function(userData) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('userData')){
					var params = VCUtils.jQuery.param({r: this.objId, userData: arguments[0].userData});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['userData'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "number")){
		...
		this.UnregisterRecoderInCallEventListener = function() {
			...
			return new Promise(function(resolve, reject){
				...
				GetRequest("VidyoRoomUnregisterRecoderInCallEventListener?" + params, OnComplete, OnError);
			});
		}
	...
	this.VidyoUser = function(endpoint) {
		...
		this.GetCurrentRoster = function(roster) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('roster')){
					var params = VCUtils.jQuery.param({u: this.objId, roster: JSON.stringify({"roster": arguments[0].roster})});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['roster'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
		...
		this.LoginAsGuest = function(displayName, host, port, serviceType, onLoginComplete, onLoggedOut, onConnectionStatusChanged, onTokenReceived, onWebProxyCredentialsRequest) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('displayName') && arguments[0].hasOwnProperty('host') && arguments[0].hasOwnProperty('port') && arguments[0].hasOwnProperty('serviceType') && arguments[0].hasOwnProperty('onLoginComplete') && arguments[0].hasOwnProperty('onLoggedOut') && arguments[0].hasOwnProperty('onConnectionStatusChanged') && arguments[0].hasOwnProperty('onTokenReceived') && arguments[0].hasOwnProperty('onWebProxyCredentialsRequest')){
					...
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['displayName', 'host', 'port', 'serviceType', 'onLoginComplete', 'onLoggedOut', 'onConnectionStatusChanged', 'onTokenReceived', 'onWebProxyCredentialsRequest'], Object.keys(arguments[0])).error);
				}
		...
		this.RegisterRoomEventListener = function(onRoomCreatedByInvite) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('onRoomCreatedByInvite')){
					this.VidyoUserOnRoomCreatedByInvite = arguments[0].onRoomCreatedByInvite;
					var params = VCUtils.jQuery.param({u: this.objId});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['onRoomCreatedByInvite'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "function")){
	...
	this.VidyoMeeting = function(){
		...
		this.AddAttendee = function(a) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('a')){
					var params = VCUtils.jQuery.param({m: this.objId, a: JSON.stringify(arguments[0].a)});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['a'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
		...
		this.GetAttendeesByRole = function(a, r) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('a') && arguments[0].hasOwnProperty('r')){
					var params = VCUtils.jQuery.param({m: this.objId, a: JSON.stringify({"a": arguments[0].a}), r: arguments[0].r});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['a', 'r'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 2 && (typeof(arguments[0]) === "object") && (typeof(arguments[1]) === "string")){
		...
		this.RespondToInvite = function(a, s) {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('a') && arguments[0].hasOwnProperty('s')){
					var params = VCUtils.jQuery.param({m: this.objId, a: JSON.stringify(arguments[0].a), s: arguments[0].s});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['a', 's'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 2 && (typeof(arguments[0]) === "object") && (typeof(arguments[1]) === "string")){
	...
	this.CreateVidyoMeetingFeedback = function(attendeeAdded, attendeeRemoved) {
		var args = [].slice.apply(arguments);
		if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
			if(arguments[0].hasOwnProperty('attendeeAdded') && arguments[0].hasOwnProperty('attendeeRemoved')){
				var params = VCUtils.jQuery.param({f: this.objId});
			} else {
				return Promise.reject(new MissingArgumentException('Missing Parameters', ['attendeeAdded', 'attendeeRemoved'], Object.keys(arguments[0])).error);
			}
		} else if (arguments.length === 2 && (typeof(arguments[0]) === "function") && (typeof(arguments[1]) === "function")){
			var params = VCUtils.jQuery.param({f: this.objId});
		} else {
		...
		if(arguments.length === 1 && arguments[0].objId && arguments[0].objType && arguments[0].objType === "VidyoMeetingFeedback"){
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('attendeeAdded') && arguments[0].hasOwnProperty('attendeeRemoved')){
					...
					throw new MissingArgumentException('Missing Parameters', ['attendeeAdded', 'attendeeRemoved'], Object.keys(arguments[0])).error;
				}
			} else if (arguments.length === 2 && (typeof(arguments[0]) === "function") && (typeof(arguments[1]) === "function")){
	...
	var callbacks = {
		...
		VidyoConnectorOnDynamicParticipantChanged: function(response) {
			...
			var remoteCamerasObj = response.remoteCameras;
			try {
				if (VidyoConnectorObj && VidyoConnectorObj.VidyoConnectorOnDynamicParticipantChanged)
					VidyoConnectorObj.VidyoConnectorOnDynamicParticipantChanged(participantsObj,remoteCamerasObj);
			}
			finally {
		...
		VidyoConnectorOnLocalCameraAdded: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnLocalCameraAddedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, localCamera: response.VidyoLocalCamera ? response.VidyoLocalCamera.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnLocalCameraRemoved: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnLocalCameraRemovedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, localCamera: response.VidyoLocalCamera ? response.VidyoLocalCamera.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnLocalCameraSelected: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnLocalCameraSelectedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, localCamera: response.VidyoLocalCamera ? response.VidyoLocalCamera.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnLocalCameraStateUpdated: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnLocalCameraStateUpdatedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, localCamera: response.VidyoLocalCamera ? response.VidyoLocalCamera.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnLocalMicrophoneAdded: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnLocalMicrophoneAddedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, localMicrophone: response.VidyoLocalMicrophone ? response.VidyoLocalMicrophone.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnLocalMicrophoneRemoved: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnLocalMicrophoneRemovedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, localMicrophone: response.VidyoLocalMicrophone ? response.VidyoLocalMicrophone.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnLocalMicrophoneSelected: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnLocalMicrophoneSelectedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, localMicrophone: response.VidyoLocalMicrophone ? response.VidyoLocalMicrophone.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnLocalMicrophoneStateUpdated: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnLocalMicrophoneStateUpdatedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, localMicrophone: response.VidyoLocalMicrophone ? response.VidyoLocalMicrophone.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnLocalMonitorAdded: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnLocalMonitorAddedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, localMonitor: response.VidyoLocalMonitor ? response.VidyoLocalMonitor.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnLocalMonitorRemoved: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnLocalMonitorRemovedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, localMonitor: response.VidyoLocalMonitor ? response.VidyoLocalMonitor.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnLocalMonitorSelected: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnLocalMonitorSelectedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, localMonitor: response.VidyoLocalMonitor ? response.VidyoLocalMonitor.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnLocalMonitorStateUpdated: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnLocalMonitorStateUpdatedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, localMonitor: response.VidyoLocalMonitor ? response.VidyoLocalMonitor.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnLocalSpeakerAdded: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnLocalSpeakerAddedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, localSpeaker: response.VidyoLocalSpeaker ? response.VidyoLocalSpeaker.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnLocalSpeakerRemoved: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnLocalSpeakerRemovedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, localSpeaker: response.VidyoLocalSpeaker ? response.VidyoLocalSpeaker.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnLocalSpeakerSelected: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnLocalSpeakerSelectedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, localSpeaker: response.VidyoLocalSpeaker ? response.VidyoLocalSpeaker.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnLocalSpeakerStateUpdated: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnLocalSpeakerStateUpdatedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, localSpeaker: response.VidyoLocalSpeaker ? response.VidyoLocalSpeaker.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnLocalWindowShareAdded: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnLocalWindowShareAddedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, localWindowShare: response.VidyoLocalWindowShare ? response.VidyoLocalWindowShare.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnLocalWindowShareRemoved: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnLocalWindowShareRemovedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, localWindowShare: response.VidyoLocalWindowShare ? response.VidyoLocalWindowShare.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnLocalWindowShareSelected: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnLocalWindowShareSelectedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, localWindowShare: response.VidyoLocalWindowShare ? response.VidyoLocalWindowShare.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnLocalWindowShareStateUpdated: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnLocalWindowShareStateUpdatedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, localWindowShare: response.VidyoLocalWindowShare ? response.VidyoLocalWindowShare.objId : 0 }), function(){}, function(){});
			}
		},
		...
		VidyoConnectorOnRemoteCameraAdded: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnRemoteCameraAddedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, remoteCamera: response.VidyoRemoteCamera ? response.VidyoRemoteCamera.objId : 0, participant: response.VidyoParticipant ? response.VidyoParticipant.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnRemoteCameraRemoved: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnRemoteCameraRemovedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, remoteCamera: response.VidyoRemoteCamera ? response.VidyoRemoteCamera.objId : 0, participant: response.VidyoParticipant ? response.VidyoParticipant.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnRemoteCameraStateUpdated: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnRemoteCameraStateUpdatedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, remoteCamera: response.VidyoRemoteCamera ? response.VidyoRemoteCamera.objId : 0, participant: response.VidyoParticipant ? response.VidyoParticipant.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnRemoteMicrophoneAdded: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnRemoteMicrophoneAddedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, remoteMicrophone: response.VidyoRemoteMicrophone ? response.VidyoRemoteMicrophone.objId : 0, participant: response.VidyoParticipant ? response.VidyoParticipant.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnRemoteMicrophoneRemoved: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnRemoteMicrophoneRemovedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, remoteMicrophone: response.VidyoRemoteMicrophone ? response.VidyoRemoteMicrophone.objId : 0, participant: response.VidyoParticipant ? response.VidyoParticipant.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnRemoteMicrophoneStateUpdated: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnRemoteMicrophoneStateUpdatedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, remoteMicrophone: response.VidyoRemoteMicrophone ? response.VidyoRemoteMicrophone.objId : 0, participant: response.VidyoParticipant ? response.VidyoParticipant.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnRemoteWindowShareAdded: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnRemoteWindowShareAddedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, remoteWindowShare: response.VidyoRemoteWindowShare ? response.VidyoRemoteWindowShare.objId : 0, participant: response.VidyoParticipant ? response.VidyoParticipant.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnRemoteWindowShareRemoved: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnRemoteWindowShareRemovedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, remoteWindowShare: response.VidyoRemoteWindowShare ? response.VidyoRemoteWindowShare.objId : 0, participant: response.VidyoParticipant ? response.VidyoParticipant.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnRemoteWindowShareStateUpdated: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnRemoteWindowShareStateUpdatedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, remoteWindowShare: response.VidyoRemoteWindowShare ? response.VidyoRemoteWindowShare.objId : 0, participant: response.VidyoParticipant ? response.VidyoParticipant.objId : 0 }), function(){}, function(){});
			}
		},
		...
		VidyoConnectorOnWebProxyCredentialsRequest: function(response) {
			...
			try {
				if (VidyoConnectorObj && VidyoConnectorObj.VidyoConnectorOnWebProxyCredentialsRequest)
					VidyoConnectorObj.VidyoConnectorOnWebProxyCredentialsRequest();
			}
			finally {
				return GetRequest("VidyoConnectorOnWebProxyCredentialsRequestComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorRecorderInCall: function(response) {
			var VidyoConnectorObj = (response.VidyoConnector) ? objects[response.VidyoConnector.objId] : null;
			var recorderInCallObj = response.recorderInCall;
			try {
				if (VidyoConnectorObj && VidyoConnectorObj.VidyoConnectorRecorderInCall)
					VidyoConnectorObj.VidyoConnectorRecorderInCall(recorderInCallObj);
			}
			finally {
				return GetRequest("VidyoConnectorRecorderInCallComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0 }), function(){}, function(){});
			}
		},
		...
		VidyoCallOnMessageReceived: function(response) {
			...
			try {
				...
				return GetRequest("VidyoCallOnMessageReceivedComplete?" + VCUtils.jQuery.param({ c: response.VidyoCall ? response.VidyoCall.objId : 0, participant: response.VidyoParticipant ? response.VidyoParticipant.objId : 0 }), function(){}, function(){});
			}
		},
		...
		VidyoEndpointOnRemoteMicrophoneStateUpdated: function(response) {
			...
			try {
				...
				return GetRequest("VidyoEndpointOnRemoteMicrophoneStateUpdatedComplete?" + VCUtils.jQuery.param({ e: response.VidyoEndpoint ? response.VidyoEndpoint.objId : 0, remoteMicrophone: response.VidyoRemoteMicrophone ? response.VidyoRemoteMicrophone.objId : 0, user: response.VidyoUser ? response.VidyoUser.objId : 0, call: response.VidyoCall ? response.VidyoCall.objId : 0, room: response.VidyoRoom ? response.VidyoRoom.objId : 0, participant: response.VidyoParticipant ? response.VidyoParticipant.objId : 0 }), function(){}, function(){});
			}
		},
		...
		VidyoEndpointOnRemoteWindowShareStateUpdated: function(response) {
			...
			try {
				...
				return GetRequest("VidyoEndpointOnRemoteWindowShareStateUpdatedComplete?" + VCUtils.jQuery.param({ e: response.VidyoEndpoint ? response.VidyoEndpoint.objId : 0, remoteWindowShare: response.VidyoRemoteWindowShare ? response.VidyoRemoteWindowShare.objId : 0, user: response.VidyoUser ? response.VidyoUser.objId : 0, call: response.VidyoCall ? response.VidyoCall.objId : 0, room: response.VidyoRoom ? response.VidyoRoom.objId : 0, participant: response.VidyoParticipant ? response.VidyoParticipant.objId : 0 }), function(){}, function(){});
			}
		},
		...
		VidyoRoomRecorderInCall: function(response) {
			...
			try {
				if (VidyoRoomObj && VidyoRoomObj.VidyoRoomRecorderInCall)
					VidyoRoomObj.VidyoRoomRecorderInCall(recorderInCallObj);
			}
			finally {
				return GetRequest("VidyoRoomRecorderInCallComplete?" + VCUtils.jQuery.param({ r: response.VidyoRoom ? response.VidyoRoom.objId : 0 }), function(){}, function(){});
			}
		},
		...
		VidyoUserOnWebProxyCredentialsRequest: function(response) {
			...
			try {
				if (VidyoUserObj && VidyoUserObj.VidyoUserOnWebProxyCredentialsRequest)
					VidyoUserObj.VidyoUserOnWebProxyCredentialsRequest();
			}
			finally {
				return GetRequest("VidyoUserOnWebProxyCredentialsRequestComplete?" + VCUtils.jQuery.param({ u: response.VidyoUser ? response.VidyoUser.objId : 0 }), function(){}, function(){});
			}
		},
